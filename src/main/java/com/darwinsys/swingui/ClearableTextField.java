...
public class ClearableTextField extends JPanel {
	...
	/** Construct a ClearableTextField with a given number of columns but no text
	 * @param columns The number of text character positions for the field to contain
	 */
	...
	/** Overrite to provide rounded panel
	 * @param g the Graphics2D used in drawing.
	 */
	@Override
	protected void paintComponent(Graphics g) {
		Graphics2D g2 = (Graphics2D) g.create();
	...
	/** Inner class for internal clear button */
